...
public class LogReader {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (Stream<Path> path_stream = Files.list(Paths.get("logs").toAbsolutePath())) {
            List<String> path_list = path_stream.filter(Files::isRegularFile).map(Path::toString).collect(Collectors.toList());
                ...
                if (file_path.contains("_vs_")) {
                    ...
                    while ((line = br.readLine()) != null) {
                        ...
                        if (line.contains("Players")) {
                            ...
                            // TODO: this is unnecessary if the server writes things properly
                            String temp = "";
